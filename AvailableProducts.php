...
$resultQuery = mysql_query($query);
			...
			?>
			 ...
			 <?php while($row = mysql_fetch_array($resultQuery)){ ?>
							<tr> <td>  <center>  <a href="AvailableProductsview.php?pdid=<?php echo $row['productcode']?>"> <img src="<?php echo checkImage($row['image0']); ?>" class="img-thumbnail" style="width: 80px; height: 80px;"> </a></center> </td>
