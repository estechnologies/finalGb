<?php
	...
	if($resultQuery == 1){
		header("Location:MTOPricingEdit.php?cdid=$cdid&msg1=MTO Pricing has been updated successfully.");
	}else{
		header("Location:MTOPricingEdit.php?cdid=$cdid&msg1=MTO Order has  updated UNsuccessfull.");
	}
