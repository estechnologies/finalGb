...
}else if($_SESSION['emp']['mtopricingEditAccess'] != '1' or $_SESSION['emp']['mtopricingAccess'] != '1'){
		...
		if($pageNumber == null or $pageNumber == '1'){
			...
			$pageNumber = ($pageNumber*5)-5;
											...
											?>
											 ...
											 <form name="search_form" method="POST" action="MTOPricingView.php">
		 ...
		 <?php 
			...
			?>
											...
											<tr><td><a href="MTOPricingEdit.php?cdid=<?php echo $row['cdid'];?>">Edit</a></td> 
        ...
        <!--
            ...
            <?php 
            	...
            	for($i = 1;$i <= $pageCount; $i++){
            		?>  <li><a href="MTOPricingView.php?page=<?php echo $i;?>"><?php  echo $i; ?></a></li> <?php 
            	}
