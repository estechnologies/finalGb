<?php 
	...
	if($resultQuery == 1){
		header("Location:MTSProductsEdit.php?id=$pdid& msg1=MTS Product has been updated successfully.");
	}else{
		header("Location:MTSProductsEdit.php?id=$pdid&msg=failed to update product");
	}
?>