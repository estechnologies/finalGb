<?php 
		...
		if(mysql_num_rows($resultQuery) <= 0){
			...
			if($resultUpdate == 1){
				...
				header("Location:MTOPricingCreate.php?msg1=MTO Pricing has been saved successfully. Pricing Id is $id");
			}else{
				header("Location:MTOPricingCreate.php?msg= failed try again..");
			}
			
		}else{
			header("Location:MTOPricingCreate.php?msg=Price is already available for selected Material Type and Thickness.<br>To Edit Pricing,<a href=MTOPricingView.php>Click Here</a>");
		}
