...
.logo_cap {  margin-top:90px; margin-bottom:70px;}
.navbar-inverse{margin-top: 100px;}
.dropdown-menu>li>a {width:225px;}
}
 ...
 <button class="btn btn-default dropdown-toggle" type="button" data-toggle="dropdown">My Account
    <span class="caret"></span></button>
      <ul class="dropdown-menu">
        <li class="headerlinks_drop"><a style="width:auto;" href="resetpassword.php">Reset Password</a></li>
        <li class="headerlinks_drop"><a style="width:auto;" href="logout.php">Logout</a></li>                        
      </ul>
    </li>
  </ul>
    </div>
	 ...
	 <li class="dropdown headerlinks" ><a class="dropdown-toggle" data-toggle="dropdown" href="#">Packing Solutions 
		    		...
		    		<ul class="dropdown-menu multi-level" role="menu" aria-labelledby="dropdownMenu">
		                		...
		                		<a tabindex="-1" href="#">MTO Bookings</a>
		               			...
		               			<?php if($_SESSION['emp']['mtobookingAccess'] == '1'){ ?>
		                 			...
		                 			<?php if($_SESSION['emp']['mtocreatebookingAccess'] == '1'){ ?> 
		                  			<li><a style="width:auto;" href="MTOBookingsCreate.php"> Create MTO Booking</a></li>
		                  			<?php }?>
		                  			
		                  			<?php if($_SESSION['emp']['mtobookingeditAccess'] == '1'){ ?> 
		                  			<li><a tabindex="-1" style="width:auto;" href="MTOBookingsView.php"> View & Edit MTO Booking</a></li>
		                  			<?php }?>
		              		...
		              		<li class="dropdown-submenu">
		                		...
		                		<?php if($_SESSION['emp']['mtopricingAccess'] == '1'){ ?> 
		               			 <ul class="dropdown-menu">
		               			 
		               			 <?php if($_SESSION['emp']['mtopricingcreateAccess'] == '1'){ ?>
		               			 <li><a style="width:auto;" href="MTOPricingCreate.php">Create MTO Pricing</a></li>
		               			 <?php }?>
		               			 
		               			 <?php if($_SESSION['emp']['mtopricingEditAccess'] == '1'){ ?>
		                 			 <li><a tabindex="-1" style="width:auto;" href="MTOPricingView.php">View & Edit MTO Pricing </a></li>
		                 			 <?php }?>
		               			 </ul>
		               			 <?php }?>
		              		</li>
		              		...
		              		<li class="dropdown-submenu">
		                		...
		                		<?php if($_SESSION['emp']['mtsproductsAccess'] == '1'){ ?>
		               			 <ul class="dropdown-menu">
		               			 
		               			 <?php  if($_SESSION['emp']['mtsproductcreateAccess'] == '1'){  ?>
		               			 <li><a style="width:auto;" href="MTSProductsCreate.php"> Create MTS Product</a></li>
		               			 <?php }?>
		               			 
		               			 <?php  if($_SESSION['emp']['mtsproducteditAccess'] == '1'){  ?>
		                 			<li><a tabindex="-1" style="width:auto;" href="MTSProductsView.php">View & Edit MTS Product </a></li>
		                 		 <?php }?> 
		              		...
		              		<li class="dropdown-submenu">
		                		...
		                		<?php if($_SESSION['emp']['mtsbookingsAccess'] == '1'){ ?>
		               			 ...
		               			 <?php if($_SESSION['emp']['mtsbookingeditAccess'] == '1'){?>
		                 			 <li><a style="width:auto;" tabindex="-1" href="MTSBookingsView.php">View & Edit MTS Bookings</a></li>
		                 		<?php }?>
		               			 </ul>
		               			 <?php } ?>
		              		</li>
