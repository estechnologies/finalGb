   ...
   <center class="message"> <label style="font-size: 14px;color:green;"><?php echo $msg1;?></label></center>
		 ...
		 <label for="Order Id">Order Id</label>
                            <div style="margin-bottom: 12px" id="widths" class="input-group">
                                       ...
                                       <input id="Order_id" name="Order_id" type="text" placeholder="Enter Oder Id" readonly required="required" oninvalid="InvalidMsgfill(this);"  oninput="InvalidMsgfill(this);" value="<?php echo $row['cdid']; ?>" class="form-control input-md">
                                    </div>
