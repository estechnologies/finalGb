...
}else if($_SESSION['emp']['mtopricingcreateAccess'] != '1' or $_SESSION['emp']['mtopricingAccess'] != '1'){
...
<nav class="navbar navbar-default navbar-fixed-top">
 ...
 <button class="btn btn-default dropdown-toggle" type="button" data-toggle="dropdown">My Account
  ...
  <center></center>
		 ...
		 <form action="empPriceCreateBack.php" method="post" enctype="multipart/form-data">
