...
}else if($_SESSION['emp']['mtsproductcreateAccess'] != '1' or $_SESSION['emp']['mtsproductsAccess'] != '1'){
...
<nav class="navbar navbar-default navbar-fixed-top">
 ...
 <button class="btn btn-default dropdown-toggle" type="button" data-toggle="dropdown">My Account
  ...
  <center></center>
		 ...
		 <form class="form-horizontal" action="empProductCreateBack.php" method="post" enctype="multipart/form-data">
		  <center><?php 
