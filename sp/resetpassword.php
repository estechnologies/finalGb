...
<center><button style="margin-bottom: 12px" type="submit" name="login-submit" id="login-submit" class="btn btn-default">Reset</button></center>
  ...
  <div class="navbar navbar-default navbar-fixed-bottom">
      <p class="footer navbar-text pull-left">
          	<a href="http://www.goodscab.com/aboutus.php" target="_blank" >About us</a>&nbsp;&nbsp; |&nbsp;
			<a href="http://www.goodscab.com/contactus.php" target="_blank">Contact</a>&nbsp;&nbsp;|&nbsp;
			<a href="http://www.goodscab.com/Terms_Privacy.html" target="_blank">Terms & Privacy</a>
