...
<center><img src="<?php echo checkImage($row['image0']); ?>" style="width: 400px; height: 264px;" border="2" class="img-thumbnail img-responsive"></center>
</a></center>
</div>
    <div class="col-md-3">
<a href="#" class="pop">
   <center> <img src="<?php echo checkImage($row['image1']); ?>" class="img-thumbnail" border="2" style=" margin-top:20px;width: 100px; height: 100px;"></center>
</a>
</div>
   <div class="col-md-3">
<a href="#" class="pop">
   <center>   <img src="<?php echo checkImage($row['image2']); ?>" class="img-thumbnail" style="margin-top:20px;width: 100px; height: 100px;"> </center> 
</a>
</div>
   <div class="col-md-3">
<a href="#" class="pop">
    <center>  <img src="<?php echo checkImage($row['image3']); ?>" class="img-thumbnail" style="margin-top:20px;width: 100px; height: 100px;"> </center> 
</a>
</div>
   <div class="col-md-3">
<a href="#" class="pop">
    <center>  <img src="<?php echo checkImage($row['image4']); ?>" class="img-thumbnail" style="margin-top:20px;width: 100px; height: 100px;"> </center> 
</a>
</div>
</div>
<div class="col-md-6">
