  ...
  <div style="margin-bottom: 12px" class="input-group">
                            ...
                            <div style="margin-bottom: 12px" class="input-group">
									...
									<div class="input-group date form_date " data-date="" data-date-format="yyyy-mm-dd" data-link-field="dtp_input2" data-link-format="yyyy-mm-dd">
										<input class="form-control" style="background-color: white;"  type="text" oninvalid="InvalidMsgdate(this);" name="dob" oninput="InvalidMsgdate(this);" required="required" value="<?php echo $row['date_of_birth']; ?>" size="16" >
